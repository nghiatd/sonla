...
class Admin_Form_Content extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $o_NameEn->setLabel('ADMIN_CONTENT_FORM_LABELS_NameEn')
        ...
        $o_NameVi->setLabel('ADMIN_CONTENT_FORM_LABELS_NameVi')
	        ->addValidator('NotEmpty')
	        ->addValidator('Alnum', true, array('allowWhiteSpace' => true))
	        ->addValidator('stringLength', false, array(5, 50))
	        ->setRequired(true)
        ...
        $o_DescEn->setLabel('ADMIN_CONTENT_FORM_LABELS_DescEn')
	        ->addValidator('Alnum', true, array('allowWhiteSpace' => true))
        ...
        $o_DescVi->setLabel('ADMIN_CONTENT_FORM_LABELS_DescVi')
	        ->addValidator('Alnum', true, array('allowWhiteSpace' => true))
	        ->addValidator('stringLength', false, array(0, 255))
	        ->setRequired(false)
	        ->setAttrib('class', 'form-control')
        ...
        $o_ParentCat->setLabel('ADMIN_CONTENT_FORM_LABELS_ParentCat')
        	  ->setAttrib('class', 'form-control')
        	  ->setRequired(true)
        	  ->setDecorators($this->_inputDecorator);

        $o_Sort = new Zend_Form_Element_Text('sort');
        $o_Sort->setLabel('ADMIN_CONTENT_FORM_LABELS_Sort')
	        ->addValidator('NotEmpty')
	        ->addValidator('Digits')
        ...
        $o_Status->setLabel('ADMIN_CONTENT_FORM_LABELS_Status')
	        ->addValidator('NotEmpty')
	        ->addValidator('stringLength', false, array(1, 5))
	        ->setRequired(true)
	        ->setValue(1)
     ...
     */
    public function v_fContentFilterForm($the_sz_ActUrl, $the_a_AllParams)
    {
    	...
    	if( $this->_locale == Zf_Util_Const::LANG_EN )
    	{
    		...
    		$o_NameEn->setLabel('ADMIN_CONTENT_TABLE_TITLE_Name')
    				->removeValidator('NotEmpty')
		    		->setRequired(false)
		    		->setAttrib('class', 'form-control')
		    		->setAttrib('placeholder', $this->_translate->translate('ADMIN_CONTENT_TABLE_TITLE_Name'))
		    		->setDecorators($this->_filterDecorators);

    		$o_DescEn = $this->getElement('description_en');
    		$o_DescEn->setLabel('ADMIN_CONTENT_TABLE_TITLE_Desc')
    				->setAttrib('class', 'form-control')
		    		->setAttrib('placeholder', $this->_translate->translate('ADMIN_CONTENT_TABLE_TITLE_Desc'))
    				->setDecorators($this->_filterDecorators);
    	...
    	else if( $this->_locale == Zf_Util_Const::LANG_VI )
    	{
    		...
    		$o_NameVi->setLabel('ADMIN_CONTENT_TABLE_TITLE_Name')
    				->removeValidator('NotEmpty')
		    		->setRequired(false)
		    		->setAttrib('class', 'form-control')
		    		->setAttrib('placeholder', $this->_translate->translate('ADMIN_CONTENT_TABLE_TITLE_Name'))
    		...
    		$o_DescVi->setLabel('ADMIN_CONTENT_TABLE_TITLE_Desc')
    				->setAttrib('class', 'form-control')
		    		->setAttrib('placeholder', $this->_translate->translate('ADMIN_CONTENT_TABLE_TITLE_Desc'))
    				->setDecorators($this->_filterDecorators);
