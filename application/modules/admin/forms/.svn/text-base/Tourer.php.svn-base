...
class Admin_Form_Tourer extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $o_Alias->setLabel('ADMIN_TOURER_FORM_LABELS_Alias')
        ...
        $o_NameEn->setLabel('ADMIN_TOURER_FORM_LABELS_NameEn')
        	->addValidator('NotEmpty')
        	->addValidator('Alnum', true, array('allowWhiteSpace' => true))
        ...
        $o_NameVi->setLabel('ADMIN_TOURER_FORM_LABELS_NameVi')
	        ->addValidator('NotEmpty')
	        ->addValidator('Alnum', true, array('allowWhiteSpace' => true))
	        ->addValidator('stringLength', false, array(5, 150))
	        ->setRequired(true)
        ...
        $o_DescEn->setLabel('ADMIN_TOURER_FORM_LABELS_DescEn')
	        ->addValidator('Alnum', true, array('allowWhiteSpace' => true))
        ...
        $o_DescVi->setLabel('ADMIN_TOURER_FORM_LABELS_DescVi')
	        ->addValidator('Alnum', true, array('allowWhiteSpace' => true))
	        ->addValidator('stringLength', false, array(0, 255))
	        ->setRequired(false)
	        ->setAttrib('class', 'form-control')
        ...
        $o_ContentEn->setLabel('ADMIN_TOURER_FORM_LABELS_ContentEn')
        	->addValidator('NotEmpty')
        ...
        $o_ContentVi->setLabel('ADMIN_TOURER_FORM_LABELS_ContentVi')
	        ->addValidator('NotEmpty')
	        ->addValidator('stringLength', false)
	        ->setRequired(true)
        ...
        $o_ParentCat->setLabel('ADMIN_TOURER_FORM_LABELS_ParentCat')
        	  ->setAttrib('class', 'form-control')
        	  ->setRequired(true)
        	  ->setDecorators($this->_inputDecorator);

        $o_Sort = new Zend_Form_Element_Text('sort');
        $o_Sort->setLabel('ADMIN_TOURER_FORM_LABELS_Sort')
	        ->addValidator('NotEmpty')
	        ->addValidator('Digits')
        ...
        $o_Status->setLabel('ADMIN_TOURER_FORM_LABELS_Status')
	        ->addValidator('NotEmpty')
	        ->addValidator('stringLength', false, array(1, 5))
	        ->setRequired(true)
	        ->setValue(1)
    ...
    public function v_fCatFilterForm($the_sz_ActUrl, $the_a_AllParams)
    {
    	...
    	if( $this->_locale == Zf_Util_Const::LANG_EN )
    	{
            ...
            $o_NameEn->setLabel('ADMIN_TOURER_TABLE_TITLE_Name')
                            ->removeValidator('NotEmpty')
                            ->setRequired(false)
                            ->setAttrib('class', 'form-control')
                            ->setAttrib('placeholder', $this->_translate->translate('ADMIN_TOURER_TABLE_TITLE_Name'))
                            ->setDecorators($this->_filterDecorators);

            $o_DescEn = $this->getElement('description_en');
            $o_DescEn->setLabel('ADMIN_CAT_TABLE_TITLE_Desc')
                            ->setAttrib('class', 'form-control')
                            ->setAttrib('placeholder', $this->_translate->translate('ADMIN_TOURER_TABLE_TITLE_Desc'))
                            ->setDecorators($this->_filterDecorators);

            $o_ContentEn = $this->getElement('content_en');
            $o_ContentEn->setLabel('ADMIN_TOURER_TABLE_TITLE_Content')
                            ->removeValidator('NotEmpty')
                            ->setRequired(false)
                            ->setAttrib('class', 'form-control')
                            ->setAttrib('placeholder', $this->_translate->translate('ADMIN_TOURER_TABLE_TITLE_Content'))
                            ->setDecorators($this->_filterDecorators);
        ...
        $o_Alias->setLabel('ADMIN_TOURER_TABLE_TITLE_Alias')
                        ->removeValidator('NotEmpty')
                        ->setRequired(false)
                        ->setAttrib('class', 'form-control')
                        ->setAttrib('placeholder', $this->_translate->translate('ADMIN_TOURER_TABLE_TITLE_Alias'))
                        ->setDecorators($this->_filterDecorators);
