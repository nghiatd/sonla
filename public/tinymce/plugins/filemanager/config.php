...
//Allowed extensions
//**********************
$ext_img = array('jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'swf','JPG', 'JPEG', 'PNG', 'GIF',); //Images
$ext_file = array('doc', 'docx', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','psd','sql','log','fla','xml','ade','adp','ppt','pptx','swf'); //Files
$ext_video = array('mov', 'mpeg', 'mp4', 'avi', 'mpg','wma','swf'); //Videos
$ext_music = array('mp3', 'm4a', 'ac3', 'aiff', 'mid','swf'); //Music
$ext_misc = array('zip', 'rar','gzip','swf'); //Archives
